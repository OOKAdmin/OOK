...
import PadeyeLoadimg from '../../images/PadEye-PadeyeLoad.png'
...
export default function Padeye() {
  ...
  if (ValueofShearStressatpinhole < AllowableShearStressatpinhole) {
    var ShearAreaofPinHole = <h1>OK</h1>;
  } else {
    var ShearAreaofPinHole = <h1 style={{ color: '#bd2323' }}>NOT OK</h1>;
  }
  ...
  if (combinedStressCheckasperAISCH21 < 1) {
    var combinedStressCheckasperAISCH21Condition = <h1>OK</h1>;
  } else {
    var combinedStressCheckasperAISCH21Condition = <h1 style={{ color: '#bd2323' }}>NOT OK</h1>;
  }
  ...
  if (CombinedStressCheckatBase < AllowableWeldStress) {
    var CombinedStressCheckatBaseCondition = <h1>OK</h1>;
  } else {
    var CombinedStressCheckatBaseCondition = <h1 style={{ color: '#bd2323' }}>NOT OK</h1>;
  }
  return (
    <>
      ...
      <section className='background-white PadEye'>
        <div className='calculator-first-section-div'>
          <div className='calculator-first-section-imgdiv'>
            <img className='calculator-first-section-imgdiv-img' src={Background} alt='' />
          </div>
        ...
        <section className='structure-analysis-calculator-calculator'>
          ...
          <div className='structure-analysis-calculator-calculator-center center'>
            {selectedOption === 'option1' && (
              <img className='Padeye-calculator-img' src={MaterialpropertyImg} alt="" />
            )}
            {selectedOption === 'option2' && (
              <img className='Padeye-calculator-img' src={PadeyegeometryImg} alt="" style={{ height: '32vw' }} />
            )}
            {selectedOption === 'option3' && (
              <img className='Padeye-calculator-img' src={shackleImg} alt="" style={{ height: '36vw', }} />
            )}
          ...
          <div className='structure-analysis-calculator-calculator-right PadeyeCalculator' >
            ...
            {selectedOption === 'option1' && (
              <>
                ...
                />
                <Outputs
                  DesignLoads={DropDowmOneMain}
                  GEOMETRYCHECK={DropDowmOnerightMain}
                  WELDCHECKATCHEEKPLATEWELD={DropDowmOnerightsecondMain}
                  STRESSCHECKSATPINHOLE={DropDowmTwoMain}
                  WELDSTRESSCHECKOFBASEWELD={DropDowmThirdMain}
                  STRESSCHECKSATBASEPLATE={DropDowmTworightMain}
                  FinalChecks={DropDowmThirdrightMain}
                  //OUtPUT VALUE
                  ...
                  MainPlateRadius={MainPlateRadius}
                  ShackleClearanceChecks={ShackleClearanceChecks}

                  BearingStressCheckatPinHole={BearingStressCheckatPinHole}
                  ShearAreaofPinHole={ShearAreaofPinHole}
                  TensileStressCheckatPinHole={TensileStressCheckatPinHole}
                  HertzContactStressCheckatPinHole={HertzContactStressCheckatPinHole}
                  StressCheckatCheekPlateWeld={StressCheckatCheekPlateWeld}

                  TensileStressCheckatBase={TensileStressCheckatBase}
                  BendingStressCheckatBaseXaxis={BendingStressCheckatBaseXaxis}
                  BendingStressCheckatBaseYaxis={BendingStressCheckatBaseYaxis}
                  ShearStressCheckatBaseYdirection={ShearStressCheckatBaseYdirection}
                  ShearStressCheckatBaseXdirection={ShearStressCheckatBaseXdirection}
                  combinedStressCheckasperAISCH21Condition={combinedStressCheckasperAISCH21Condition}

                  CombinedStressCheckatBaseCondition={CombinedStressCheckatBaseCondition}
                />
              </>
            )}
            {selectedOption === 'option2' && (
