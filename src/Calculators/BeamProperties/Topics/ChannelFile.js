...
export default function ChannelFile(props) {
...
// ImperialTValue
  ...
  const [ImperialCentroidYc, setImperialCentroidYc] = useState(0);
  ...
  const [ImperialSectionModulesSx, setImperialSectionModules] = useState(0);
