...
export default function LsectionFile(props) {
    ...
    const [ImperialSectionModulusSx, setImperialSectionModulusSx] = useState(0);
    ...
    const [ImperialSectionModulusSy, setImperialSectionModulusSy] = useState(0);
