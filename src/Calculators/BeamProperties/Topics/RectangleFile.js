...
export default function RectangleFile(props) {
  const units = ['mm', 'cm', 'm'];
  ...
  const [CentriodYc, setCentriodYc] = useState(0);
  ...
  const [SectionModulesSx, setSectionModulesSx] = useState(0);
  ...
  useEffect(() => {
    ...
    if (!isNaN(value)) {
      ...
      const sectionModulesValue = (b * Math.pow(d, 2) / 6);
      ...
      // Format the output based on the selected unit
      const formattedValue = SectionModulesSxSelectedUnit === 'm³' 
        ? convertedValue.toExponential(2) // 2 decimal places in scientific notation
        : convertedValue.toFixed(3); // 3 decimals for other units
  
      setSectionModulesSx(formattedValue);
    }
  ...
  const [SectionModulesSy, setSectionModulesSy] = useState(0);
  ...
  useEffect(() => {
    ...
    if (!isNaN(value)) {
      const sectionModulesValue = (d * Math.pow(b, 2) / 6);
      ...
      // Format the output based on the selected unit
      const formattedValue = SectionModulesSelectedUnitSy === 'm³' 
        ? convertedValue.toExponential(2) // 2 decimal places in scientific notation for m³
        : convertedValue.toFixed(3); // 3 decimals for other units
  
      setSectionModulesSy(formattedValue);
    }
  ...
  const [inputValueImperial, setInputValueImperial] = useState(0);
  ...
  const [HeightInputValueImperial, setHeightInputValueImperial] = useState(0);
  ...
  const [AreaImperial, setAreaImperial] = useState(0);
  ...
  const [CentroidXcImperial, setCentroidXcImperial] = useState(0);
  ...
  const [CentriodYcImperial, setCentriodYcImperial] = useState(0);
  ...
  // MomentOfInertia Ix
  const [momentOfInertiaIxImperial, setMomentOfInertiaIxImperial] = useState(0);
  ...
  // MomentOfInertia Iy
  const [momentOfInertiaIyImperial, setMomentOfInertiaIyImperial] = useState(0);
  ...
  const [SectionModulesSxImperial, setSectionModulesSxImperial] = useState(0);
  ...
  const [SectionModulesSyImperial, setSectionModulesSyImperial] = useState(0);
  ...
  const [torsionalConstantImperial, setTorsionalConstantImperial] = useState(0);
