...
export default function HollowReactangleFile(props) {
  ...
  const [inputInnerValue, setinputInnerValue] = useState(0);
  ...
  const [HeightInnerInputValue, setHeightInnerInputValue] = useState(0);
...
// Ix
  ...
  const [inputInnerValueImperial, setInputInnerValueImperial] = useState(0);
  ...
  const [HeightInnerInputValueImperial, setHeightInnerInputValueImperial] = useState(0);
  ...
  const [centroidYcImperial, setCentroidYcImperial] = useState(0);
  ...
  const [sectionModulusSxImperial, setSectionModulusSxImperial] = useState(0);
  ...
  const [sectionModulusSyImperial, setSectionModulusSyImperial] = useState(0);
