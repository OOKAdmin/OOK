                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
                            ...
                            <div>
                                ...
                                <br />
                                <br />
                                <h3 className='calculator-info-blue-section-main-topic TopicOfDropdown' style={{ padding: '0', margin: 'auto', width: '85%', justifyContent: 'left', fontSize: '2.2vw', important: true }}>	Young’s modulus (<span className='power' style={{ fontSize: '1.5vw', top: '0px', color: '#000', fontFamily: "'Kanit', sans-serif !important", fontWeight: '300' }}>  E</span>) :</h3>
                                ...
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>S.I Units: Pascal (Pa).</h3>
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>Imperial units: Pounds per square inch (psi).</h3>
                                <br />
                                <br />
                                <div style={{ justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
                                    <hr style={{ width: '80%' }} />
                                ...
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>S.I Units: millimeter
                                    <span className='power' style={{ fontSize: '1.2vw', marginRight: '2px' }}>  4 </span>
                                    (mm
                                    <span className='power' style={{ fontSize: '1.2vw', marginRight: '2px' }}>  4</span>
                                    ).</h3>
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>Imperial units: inch
                                    <span className='power' style={{ fontSize: '1.2vw', marginRight: '2px' }}>  4 </span>
                                    (in
                                    <span className='power' style={{ fontSize: '1.2vw', marginRight: '2px' }}>  4</span>
                                    ) .</h3>
                                ...
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>S.I Units: Newton (N).</h3>
                                <h3 className='calculator-info-blue-section-main-topic DefinatinOfDropDown' style={{ padding: '0', margin: 'auto', width: '80%', justifyContent: 'left' }}>Imperial units: Pound (lb).</h3>
                                <br />
                                <br />
                                <br />
                                <br />
                        ...
                        <h3 className='calculator-info-blue-section-main-topic TopicOfDropdown' style={{ padding: '0', margin: 'auto', width: '90%', justifyContent: 'left', fontSize: '2vw', important: true }}>
                            Essential components in a structure that provide stability and resistance to forces under various loads acting on it.</h3>
                        <br />
                        <h3 className="calculator-info-blue-section-main-topic TopicOfDropdown" style={{ padding: '0px', margin: 'auto', width: '90%', justifyContent: 'left', fontSize: '2.5vw', }}>Type of supports:</h3>
                        <br />
